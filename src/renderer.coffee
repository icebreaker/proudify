...
class Renderer
  constructor: ( element, settings )->
    ...
    @preloader  = $( document.createElement( 'li'  ) ).addClass( 'item loading' )

    @preloader.html( $( document.createElement( 'span' ) ).addClass( 'desc' ).html( @settings.loading_message ) ).appendTo wrapper
